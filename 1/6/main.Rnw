...
<<read-complex>>=
dfnrr <- read.samples('data/nik/complexH', 'h0aog5.dat', 'h1aog5.dat')

dfcoop <- read.samples('data', 'coop_c_h0.dat', 'coop_c_h1.dat')

dfwat <- read.samples('data', 'wat_c_h0.dat', 'wat_c_h1.dat')

dfza <- read.samples('data', 'za_c_h0.dat', 'za_c_h1.dat')

dfzc <- read.samples('data', 'zc_c_h0.dat', 'zc_c_h1.dat')

dfzk <- read.samples('data', 'zk_c_h0.dat', 'zk_c_h1.dat')
@
