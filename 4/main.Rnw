...
сложных гипотезах (при использовании для вычисления оценок метода
максимального правдоподобия по негруппированным данным). Сравнение
мощности критерия Никулина с мощностью критерия $\chi^2$ Пирсона.
Исследовать мощности критерия Никулина в зависимости от числа интервалов
группирования.
